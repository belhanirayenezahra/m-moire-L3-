<?php
	...
	if(empty($info['errors']))
	{
		...
		$arr['city'] 		= $_POST['city'];
		$arr['phone_numbre'] = $_POST['phone_numbre'];
		$arr['password'] 	= password_hash($_POST['password'], PASSWORD_DEFAULT);
		
	

		db_query("insert into users (firstname,lastname,gender,password,email,city,phone_numbre,birthday) values (:firstname,:lastname,:gender,:password,:email,:city,:phone_numbre,:birthday)",$arr);
